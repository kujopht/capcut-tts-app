...
TRANG THAI: THIET KE + logic thuan CO TEST. CHUA ap schema production (xem
`scripts/setup_appwrite.py`, cac dong danh dau "THIET KE — CHUA AP" o cuoi
SCHEMA), CHUA noi vao bat ky route hay giao dien nao. Ly do tach rieng khoi
`server/gamification.py` (thanh tuu, DA hoat dong that): cac ban ghi o day
can BANG MOI de luu XP luy ke va ton kho vat pham — dua ra truoc khi co
bang that de logic (cong thuc XP, rut thuong) duoc kiem doc lap voi ha tang.
