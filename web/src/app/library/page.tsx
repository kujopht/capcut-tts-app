...
export default function LibraryPage() {
  ...
  if (!profile) {
    return (
      // Themed Page Hero V1 — "Arcane Archive": navy hoang gia + ngoc bich
      // dam + vang co dien. Dung LAI PageHeader (khong con <h1> tran) de
      // nhat quan voi nhanh da dang nhap ben duoi — cung mot he thong.
