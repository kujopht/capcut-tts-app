...
export default function AudioStudio() {
  ...
  return <section className="audio-studio" aria-label="Audio Studio">
    <div className="audio-studio-intro"><p className="eyebrow">AUDIO STUDIO</p><h2>Tạo lời đọc</h2><p className="hint">Dán văn bản, chọn giọng, nghe và tải audio. Video chỉ là lựa chọn tiếp theo khi bạn cần nó.</p></div>
    <TtsPanel voices={voices} giong={voice} onGiong={setVoice} dangTao={creating} loi={notice} onTao={create} job={jobs.dangChay[0] ?? null} />
